		...
		while(true)
		{
			...
			switch(Integer.parseInt(sc.nextLine()))
			{
				...
				case 2: 
					...
					int shiftstarttime = Integer.parseInt(sc.nextLine());
					System.out.println("Shift endtime: ");
					int shiftendtime = Integer.parseInt(sc.nextLine());
					System.out.println("No.of.Customers:");
					int customers = Integer.parseInt(sc.nextLine());
					System.out.println("Date: ");
					String date = sc.nextLine();
					Register r1 = new Register(firstname, lastname, emailid, phonenumber, shiftstarttime, shiftendtime, customers, date);
				...
				case 4:
					...
					int nshiftstarttime = Integer.parseInt(sc.nextLine());
					System.out.println("Shift endtime: ");
					int nshiftendtime = Integer.parseInt(sc.nextLine());
					System.out.println("No.of.Customers:");
